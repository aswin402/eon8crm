          ...
          <div className="bg-card border border-border/80 rounded-xl shadow-2xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in-95 duration-150">
            <div className="px-5 py-4 border-b border-border/80 flex items-center justify-between">
              <div>
                ...
                <p className="text-[11px] text-muted-foreground mt-0.5">Record labor costing against an active project</p>
              </div>
              <button
            ...
            <form onSubmit={handleCreateManualEntry} className="p-5 space-y-4 text-xs">
              ...
              <div className="flex items-center gap-2 pt-1">
                ...
                />
                <label htmlFor="isBillableCheck" className="text-xs font-medium text-foreground cursor-pointer">
